...
def attack(char_name: str, char_class: str) -> str:
    """Attack training. Increases the skill score."""
    ...
    if char_class == 'healer':
        return (f'{char_name} нанёс урон противнику равный '
                '{5 + randint(-3, -1)}')
    return (F'{char_name} не атаковвал')


def defence(char_name: str, char_class: str) -> str:
    """Damage block training. Increases the skill score."""
    if char_class == 'warrior':
...
def special(char_name: str, char_class: str) -> str:
    """Superpower training. Increases the skill score."""
    if char_class == 'warrior':
...
def start_training(char_name: str, char_class: str) -> str:
    """Give a choice of the type of training."""
    if char_class == 'warrior':
...
def choice_char_class() -> str:
    """Describe character classes and lets the user choose a class."""
    approve_choice: str = ''
    char_class: str = ''
